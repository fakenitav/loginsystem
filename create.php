<?php
 ...
 <html lang="en" >
  <head>
   <meta charset="UTF-8">
   <title>Hi Five Registration</title>
     <style>
 ...
 * { -webkit-box-sizing:border-box; -moz-box-sizing:border-box; -ms-box-sizing:border-box; -o-box-sizing:border-box; box-sizing:border-box; }
 ...
 <body>
   <a href="http://localhost/loginsystem/index.php"><img src="logo.png" alt="Logo" hspace='580px' class="logo"></a>
   <div class="login">
     ...
     <form method="post" action="includes/signup.php">
       ...
       <input type="text" name="uid" placeholder="Username" required="required" />
         ...
         <input type="submit" class="btn btn-primary btn-block btn-large" name="submit" value="Sign Up">
     </form>
 </div>
 </body>
</html>
